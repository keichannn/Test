...
<body>
	...
	<div style="position:fixed; width:100%; height:80px; z-index: 2; margin-top:-150px;" class="navbar navbar-expand-sm navbar-dark bg-info mb-3">
...
<!-- 	</div> -->
	...
	<div style="text-align: center; margin-top: 150px;padding-top:90px;">
		<a href="syukkin.jsp" class="btn btn-primary btn-lg active Top m-5"
			role="button" aria-pressed="true">出退勤登録</a> <a href="SyuttaikinServlet"
			class="btn btn-primary btn-lg active" role="button"
			aria-pressed="true">出退勤状況</a>
	</div>
