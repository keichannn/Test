...
<!-- 	</div> -->
	...
	<div style="text-align: center; margin-top: 150px; padding-top:90px;"
		...
		<c:if test="${userinfo.role_id == 1}">
			...
			<a href="UserInsertServlet"
				class="btn btn-primary btn-lg active Top m-5">新 規 登 録</a>
		</c:if>

<!-- 		<a href="UserChangeServlet" -->
<!-- 			class="btn btn-primary btn-lg active Top m-5">ユーザ編集</a> -->

		<c:if test="${userinfo.role_id == 1}">

			<a href="userList?selectButton=timeEdit"
				class="btn btn-primary btn-lg active Top m-5">時 間 修 正</a>
		</c:if>
	</div>
	<br>
	<br>
...
<!-- 	<div -->
<!-- 		style="position: absolute; text-align: left; left: 0%; bottom: 0%;"> -->
